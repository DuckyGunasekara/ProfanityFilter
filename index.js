...
var finalList;
var divider = '\r\n';
function googleWords() {
    return __awaiter(this, void 0, void 0, function () {
        var inputFile, googleInput, input_whole_val, x, y;
        return __generator(this, function (_a) {
            inputFile = 'sourcefiles/googleWords.csv';
            googleInput = fs.readFileSync(inputFile);
            input_whole_val = googleInput.toString().split(divider);
...
function writeList() {
    return __awaiter(this, void 0, void 0, function () {
        var finalText, listCounter, listSize;
        return __generator(this, function (_a) {
            finalText = '';
            listCounter = 0, listSize = finalList.length;
